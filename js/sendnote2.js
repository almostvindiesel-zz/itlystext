...
var FoursquareVenue = function (page) {
	...
	this.setSourceId = function () {
		...
		this.source_id = $("[property='al:iphone:url']").first().attr('content').replace('foursquare://venues/','');
	}
	...
	this.setLatitude = function () {
		...
		this.location.latitude = $("[property='playfoursquare:location:latitude']").first().attr('content');
	}
	...
	this.setLongitude = function () {
		...
		this.location.longitude = $("[property='playfoursquare:location:longitude']").first().attr('content');
	}
...
var TripadvisorVenue = function (page) {
	...
	this.setLatitude = function () {
		try {
			...
			this.location.latitude = $(".mapContainer").first().attr('data-lat');
	...
	this.setLongitude = function () {
		try {
			...
			this.location.longitude = $(".mapContainer").first().attr('data-lng');
	...
	this.setRating = function () {
		...
		this.rating = $("[property='ratingValue']").first().attr('alt').substring(0, 3);
	} 
...
var YelpVenue = function (page) {
	...
	this.setCity = function () {
		try {
			...
			this.location.city = $("[itemprop='addressLocality']").first().text();
	...
	this.setRating = function () {
		try {
			...
			this.rating = $("[itemprop='ratingValue']").first().attr('content');
		} catch(err) {
	...
	this.setReviews = function () {
		try { 
			...
			this.reviews = $("[itemprop='reviewCount']").first().text();
		} catch(err) {
